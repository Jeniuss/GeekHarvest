...
/**
 * Created by Jee on 3/22/2017 AD.
 */

public class CorianderInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._coriander);
        ...
        crop2 = (Button)findViewById(R.id.bntCrop2);
