...
/**
 * Created by Jee on 8/15/2017 AD.
 */

public class SweetBasilInfo extends AppCompatActivity {
    private Button crop11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._sweetbasil);
        ...
        crop11 = (Button)findViewById(R.id.bntCrop11);


        crop11.setOnClickListener(new View.OnClickListener(){
            @Override
                ...
                mDatabase.child("nameOfPlant").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(nameOfPlant.equals("")){
                            mDatabase.child("nameOfPlant").setValue("SweetBasil");
                        }else{
