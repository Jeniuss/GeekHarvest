...
public class SantaTomatoInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._santa_tomato);
        ...
        crop9 = (Button)findViewById(R.id.bntCrop9);


        crop9.setOnClickListener(new View.OnClickListener(){
            @Override
                ...
                mDatabase.child("nameOfPlant").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(nameOfPlant.equals("")){
                            mDatabase.child("nameOfPlant").setValue("SantaTomato");
                        }else{
