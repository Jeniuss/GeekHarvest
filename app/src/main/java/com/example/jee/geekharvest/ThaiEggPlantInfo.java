...
public class ThaiEggPlantInfo extends AppCompatActivity {
    private Button crop12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        crop12 = (Button)findViewById(R.id.bntCrop12);


        crop12.setOnClickListener(new View.OnClickListener(){
            @Override
