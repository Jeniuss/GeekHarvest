...
public class SpinachInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._spinach);
        ...
        crop10 = (Button)findViewById(R.id.bntCrop10);


        crop10.setOnClickListener(new View.OnClickListener(){
            @Override
                ...
                mDatabase.child("nameOfPlant").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(nameOfPlant.equals("")){
                            mDatabase.child("nameOfPlant").setValue("Spinach");
                        }else{
