...
public class RadishInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._radish);
        ...
        crop8 = (Button)findViewById(R.id.bntCrop8);


        crop8.setOnClickListener(new View.OnClickListener(){
            @Override
                ...
                mDatabase.child("nameOfPlant").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(nameOfPlant.equals("")){
                            mDatabase.child("nameOfPlant").setValue("Radish");
                        }else{
