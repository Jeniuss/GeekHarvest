...
public class KaleInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        crop6 = (Button)findViewById(R.id.bntCrop6);
                ...
                mDatabase.child("nameOfPlant").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(nameOfPlant.equals("")){
                            mDatabase.child("nameOfPlant").setValue("Kale");
                        }else{
