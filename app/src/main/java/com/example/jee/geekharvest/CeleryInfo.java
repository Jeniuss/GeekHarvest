...
public class CeleryInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._celery);
        ...
        crop4 = (Button)findViewById(R.id.bntCrop4);
                ...
                mDatabase.child("nameOfPlant").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(nameOfPlant.equals("")){
                            mDatabase.child("nameOfPlant").setValue("Celery");
                        }else{
